...
def glm52_kt_mtp_shared_modules(
    ...
    transient duplication exceeds the RTX 3090 headroom.  Reusing the target
    modules at construction preserves the established weight-sharing
    semantics without the temporary allocation.
    """
