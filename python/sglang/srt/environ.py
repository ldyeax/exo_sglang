...
class Envs:
    ...
    # Quantize and Marlin-pack the independently materialized FR-Spec draft
    # LM head. The shared target head is never eligible for this conversion.
    SGLANG_FR_SPEC_FP8_MARLIN_HEAD = EnvBool(False)
