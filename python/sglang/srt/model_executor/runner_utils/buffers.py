    ...
    def create(
        ...
        *,
        ...
        with torch.device(device):
            ...
            if pp_size > 1:
                # PP proxy tensors are token-major, not request-major.  A
                # speculative verify graph carries multiple token rows per
                # request and must retain all of them between pipeline stages.
